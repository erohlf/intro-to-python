...
class TestCases(unittest.TestCase):
    ...
    def test_read_file_0(self):
        quakes = []
        quakes.append(quake_funcs.Earthquake("12km SSW of Idyllwild, CA",
                                             0.97, -116.7551651, 33.6391678,
                                             1488177290))
    ...
    def test_mag_2(self):
        ...
        low = 0
        high = 1
        self.assertEqual(quake_funcs.filter_by_mag(quakes, low, high), quakes)
    ...
    def test_place_1(self):
        ...
        quakes.append(quake_funcs.Earthquake("12km SSW of Idyllwild, CA",
                                             ...
                                             1488177290))
        word = 'ca'
        self.assertEqual(quake_funcs.filter_by_place(quakes, word), quakes)
